...
/*\\\CORRIGIRRRRRRRRRRRRR\\\*/
SELECT year, name AS sender, name AS receiver
FROM packages
INNER JOIN users ON users.id = packages.id_package 
WHERE NOT address = 'Taiwan' AND color = 'blue' OR year = 2015;